...
func Join[V cmp.Ordered](x iter.Seq[V], y iter.Seq[V]) iter.Seq2[V, V] {
	return JoinFunc[V, V](x, y, cmp.Compare[V])
}

func JoinFunc[V1, V2 any](x iter.Seq[V1], y iter.Seq[V2], f func(V1, V2) int) iter.Seq2[V1, V2] {
